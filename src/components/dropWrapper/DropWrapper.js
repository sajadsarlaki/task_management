    ...
    <>
      <div ref={drop} className={'drop-wrapper'}>
        <div className="drop-wrapper__header">
          <p className="drop-wrapper__header-txt">
            {column.status.toUpperCase()}
          </p>
          <span className={'drop-wrapper--icon'} onClick={showPopup}>
            🗑️
          </span>
          <Popup
            incomingFunction={deleteColumn}
            incomingArg={column.status}
            show={riseDeletePopup}
